...
Mat template_shelf_square_model_zxlhg()
{
  ...
  p1_2.x =
    p1.x + 4 * half_rect_width + ( int )((0.04 + 0.54) / RESOLUTION + 0.5);
  p1_2.y = p1.y;
  ...
  p4_2.x =
    p4.x + 4 * half_rect_width + ( int )((0.04 + 0.54) / RESOLUTION + 0.5);
  p4_2.y = p4.y;
...
void template_generate_test(int argc, char **argv)
{
  ...
  //* ft_01
  {
    ...
    template_genertor_query.request.templete_path = "/home/lile/ft/ft_01_algo.png";
...
/**/
  ...
  //* ft_02
  {
    ...
    template_genertor_query.request.point_array = point_array;
    template_genertor_query.request.line_array = line_array;
    template_genertor_query.request.templete_path = "/home/lile/ft/ft_02_algo.png";
...
/**/
  ...
  //* ft_03
  {
    ...
    template_genertor_query.request.point_array = point_array;
    template_genertor_query.request.line_array = line_array;
    template_genertor_query.request.templete_path = "/home/lile/ft/载货4_algo.png";
...
Mat generate_pallet()
{
  ...
  p11.x = p22.x = p33.x = p44.x = p55.x = p66.x = board_size + int(leg_height / RESOLUTION);
  p11.y = board_size;
...
Mat generate_chengdubili()
{
  ...
  p3_0 = Point((phy_p3.x - l4/2)/RESOLUTION + 0.5, (phy_p3.y - l3/2)/RESOLUTION + 0.5)  + offset;
  p3_1 = Point((phy_p3.x + l4/2)/RESOLUTION + 0.5, (phy_p3.y - l3/2)/RESOLUTION + 0.5) + offset;
  p3_2 = Point((phy_p3.x - l4/2)/RESOLUTION + 0.5, (phy_p3.y + l3/2)/RESOLUTION + 0.5) + offset;
...
int main(int argc, char** argv)
{
  ...
  {
    Mat model = generate_chengdubili();

    std::vector<int> compression_params;
    compression_params.push_back(CV_IMWRITE_PNG_COMPRESSION);
    compression_params.push_back(0);

    std::string image_path = getenv("HOME") + std::string("/probability_grid.png");
    imwrite(image_path, model, compression_params);
